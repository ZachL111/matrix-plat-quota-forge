"""Regression checks for the matrix-plat-quota-forge casebook."""
...
from casebook.harness import assert_expected, matrix_plat_quota_forge_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(matrix_plat_quota_forge_summary(), assert_expected())
